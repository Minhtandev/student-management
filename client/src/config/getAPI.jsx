...
export const studentInfoArr = [
  {
    ID: "001",
    Name: "Nguyễn Văn A",
    Gender: "Nam",
    Birthdate: "12/02/20020",
    Address:
  ...
  {
    ID: "005",
    Name: "Công Tằng Tôn Nữ Nguyễn Thị Ánh Hoa",
    Gender: "Nam",
    Birthdate: "12/02/20020",
    Address:
      "135 Đ. Nam Kỳ Khởi Nghĩa, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh",
...
export const classListArr = studentInfoArr.map((item) => {
  return {
    ID: item.ID,
    Name: item.Name,
  };
